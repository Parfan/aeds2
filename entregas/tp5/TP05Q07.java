...
public class TP05Q07 {
    public static void main(String[] args) {
        ...
        HashLista gameHash = new HashLista();
...
class HashLista {
	...
	HashLista(int tamTab) {
		this.tamTab = tamTab;
		tab = new GameList[tamTab];
	...
	Game get(String s) {
		...
		for (int i = 0; i < tab[pos].size(); i++) {
			if (tab[pos].get(i).getName().equals(s))
				return tab[pos].get(i);
		}
		return null;
	}
...
class GameList extends ArrayList<Game> {
}
